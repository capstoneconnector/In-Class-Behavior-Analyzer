...
o   Pre-Condition: Class must be in session
o   Post-Condition: The system records details of the changes made by the Instructor
o   Normal flow: Reconfigured classroom setting
o   Exception: Classroom in not in session therefore no need to reconfigured classroom
o   Priority: High
o   Frequency of use: Anytime class is in session which is about 2-3 times a week per class
o   Assumption: Class is assumed to be in session

Use case name: Search, delete, and add students to database 
o   Primary Actor: Administrator
o   Summary Description: Administrator specifies the desire to search, delete, and add students to database. The system either allows the administrator to search, delete, and add students to database or informs the administrator that there is no data available.
o   Trigger: Requester indicates they want to search, delete, and add students to database
o   Pre-Condition: There must be students to populate the database
o   Post-Condition: The system records details of the changes made by the administrator
o   Normal flow: Search, delete, and add students to database
o   Exception: No data available in database to edit
o   Priority: Medium
o   Frequency of use: Anytime administrator wants to view data
Assumption: Data is assumed to be available in database
Use case name: Review room layout history 
o   Primary Actor: Administrator
o   Secondary Actor: Instructor
o   Summary Description: Administrator and instructor specify the desire to be able to see the room layouts saved by the instructor. The system either allows the administrator and instructor to review room layout history or informs the administrator and instructor that there is no data saved in the database.
o   Trigger: Requester indicates they want to review room layout history
o   Pre-Condition: The teachers must save the room layout
o   Post-Condition: The system records details of new data to alert administrator of changes
o   Normal flow: Review room layout history
o   Exception: No data available in database to review
o   Priority: High
o   Frequency of use: Anytime administrator wants to view data
Assumption: Data is assumed to be available in database
Use case name: Review demographics information
o   Primary Actor: Students
o   Secondary Actor: Administrator
o   Summary Description: Students and Administrator specify the desire to be able to see review/edit demographics information. The system either allows the student and administrator to review demographics information or informs the student or administrator that there is no data saved in the database.  
o   Trigger: Requester indicates they want to review demographics information
o   Pre-Condition: The student must enter data
o   Post-Condition: The system records details of new data
o   Normal flow: Review demographics information
o   Exception: No data available in database to review
o   Priority: Medium
o   Frequency of use: Anytime student or administrator want to review data
Assumption: Data is assumed to be available in database

Functional requirements:
If the class is in session the instructor can reconfigure classroom layout.
o   Priority: High
o   Availability: The system should be available to use anytime especially after classroom times.
o   Instability: The user should be able to easily download the application.
o   Integrity: The system should protect against unauthorized addition, deletion, or modification of data.
o   Interoperability: The system should be able to export classroom setting data.
o   Performance: The system should update the data entered frequently.
o   Reliability: The system should be able to run without failure for some time.
o   Robustness: The system should be able to gracefully accept erroneous input from the instructor without crashing.
o   Security: The system should restrict unauthorized access to the instructors account.  
...
o   Priority: Medium
o   Availability: The system should allow students and instructors to be able to login to application anytime, especially during classroom hours.  
o   Instability: The application should be easy to download, login, and uninstall.
o   Integrity: The system should update frequently to prevent data loss.
o   Interoperability: The system should be able to exchange date with other systems in order for the administrator to access the data.
o   Performance: The system should respond to user inputs at a reasonable time.
o   Reliability: The system should be able to run without failure for a long period of time.
o   Robustness: The system should be able to function even if user entered erroneous input. It should be able to inform the user if the input they entered in the login is not the correct.
o   Security: The system should protect against unauthorized access by requesting password. 
o   Usability: The system’s login should be easy to use.
### Must be accessible in IOS and Android devices
o   Priority: Medium
o   Availability: The system should be available in IOS and Android devices.
o   Instability: The system should be easy to install and uninstall in both IOS and Android devices.
o   Integrity: The system should update frequently to prevent data loss.
o   Interoperability: The system should be able to exchange date with other systems.
o   Performance: The system should respond to user inputs at a reasonable time in both IOS and Android devices.
o   Reliability: The system should be able to run without failure for a long period of time in both IOS and Android devices.
o   Robustness: The system should be able to function even if user entered erroneous input in both IOS and Android devices.
o   Security: The system should protect against unauthorized access.
o   Usability: The application should be easy to use in both IOS and Android devices.
